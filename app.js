...
const RN_ILLUST_VERSION = 'textrecovery04-illust-lite-20260629';
...
async function load(){
  const res=await fetch('data/rice_navi_data.json?v=textrecovery05-storylist-20260629',{cache:'no-store'});
  ...
  $('#lang').onchange=e=>{S.lang=e.target.value;updateStaticI18n();render()};
...
function renderFuture(){
 ...
 <div class="story-title-list">${storyRows}</div>
