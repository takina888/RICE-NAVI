...
const RN_ASSET_VERSION='78ui44';
const $=s=>document.querySelector(s);

/* v78.44 compatibility aliases for old visual override layers */
...
async function load(){
  const home=$('#home');
  try{
    const res=await fetch('data/rice_navi_data.json?v=78ui44',{cache:'no-store'});
...
/* === v78.44 public UI cleanup: hide internal labels and make navigation buttons reliable. === */
...
/* === v78.44 sweep pass: public text scrub + safer internal navigation. === */
...
/* v78.44: start after public cleanup overrides are defined. */



/* === v78.44 relationship-link sweep: add links where links should exist, not only repair broken links. === */
...
/* v78.44: start moved by v78.44. */


/* === v78.44 iterative sweep: public wording, link presence, and readable text guard === */
...
function v787EnsureBackLinks(root=document){
  try{
    // Any article/item/card with details should have a safe related-link panel after v78.44.
...
/* v78.44: start after font/link/internal-word overrides are defined. */
load();

/* v78.44 learn-section cleanup
...
/* v78.44 GPS water-quality workflow
...
/* === v78.44 daily-page redesign: one daily item only; archive/search separated ===
...
/* === v78.44 archive UX: title list + tap-to-open details + back controls ===
...
/* === v78.44: homepage as attraction/navigation entry + organized UI icons === */
const RN_BUILD_V7813='v78.44 / build 78ui44';
...
/* === v78.44: rice variety visual category continuation + cleaner public pages === */
const RN_BUILD_V7814='v78.44 / build 78ui44';
...
/* === v78.44 visual asset continuation: illustrations + fixed folder references === */
...
const renderHomeV7817=function(){
  ...
  $('#home').innerHTML=`<div class="home-v7813 home-v7814">
    ...
    <p class="rn-version-v7813">RICE NAVI v78.44 / build 78ui44</p>
  </div>`;
};
...
/* === v78.44 page visual continuation: header illustrations + compact page logic ===
...
/* === v78.44 visual balance + safe public display continuation ===
   Keep home as an entry/search page. Keep detail pages title-first. */
const RN_PUBLIC_BUILD_V7819='RICE NAVI v78.44 / build 78ui44';
...
/* === v78.44 semantic visual continuation: more UI icons + no-root-asset bug cleanup === */
const RN_PUBLIC_BUILD_V7823='RICE NAVI v78.44 / build 78ui44';
...
/* === v78.44 country/story visual expansion ===
...
const RN_PUBLIC_BUILD_V7824='RICE NAVI v78.44 / build 78ui44';
...
/* === v78.44 visual discovery pass: show country/story visuals only as entry points === */
const RN_PUBLIC_BUILD_V7825='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44: keep homepage as a concise entry point.
...
function rnFocusEntryV7826(kind,title,sub,key,onclick){
  const src = kind==='story'
    ...
    : kind==='country'
      ...
      : `assets/illustrations/${key}.svg?v=78ui44`;
...
const RN_PUBLIC_BUILD_V7826='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44: illustration insertion continuation. Focus only on visual assets and where they appear. */
function rnAsset7827(folder,name){return `assets/${folder}/${pEsc(name)}.svg?v=78ui44`;}
...
const RN_PUBLIC_BUILD_V7827='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44: illustration insertion continuation. More story/country/rice visuals, no UI detour. */
...
const RN_PUBLIC_BUILD_V7828='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44: illustration insertion continuation only. More story/country/rice visual mappings. */
...
const RN_PUBLIC_BUILD_V7829='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44: illustration continuation only. Add more cultural/rice-type mappings. */
...
const RN_PUBLIC_BUILD_V7830='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 illustration continuation: more story and rice-type matching */
const RN_PUBLIC_BUILD_V7831='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 illustration continuation: rice processing, daily cards, water/storage visuals */
const RN_PUBLIC_BUILD_V7832='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 illustration continuation: Japanese/Taiwan/home-water and regional rice visuals */
const RN_PUBLIC_BUILD_V7833='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 illustration continuation: regional dishes and theme header matching */
const RN_PUBLIC_BUILD_V7834='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 illustration continuation: restored from v78.44 package, re-applied v78.44-v78.44 visual batches, then added quality/storage/factory visuals */
const RN_PUBLIC_BUILD_V7838='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 illustration continuation: seed, cultivation, quality, traceability matching */
const RN_PUBLIC_BUILD_V7839='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 illustration continuation: future and resilience category coverage */
const RN_PUBLIC_BUILD_V7840='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 illustration continuation: glossary, literature, ranking, search-link coverage */
const RN_PUBLIC_BUILD_V7841='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 illustration continuation: daily, fortune, GPS, troubleshoot linkage coverage */
const RN_PUBLIC_BUILD_V7842='RICE NAVI v78.44 / build 78ui44';
...
/* v78.44 GitHub upload under-100-files mode:
   visual SVGs are bundled in js/visual_assets.js as data URIs. */
const RN_PUBLIC_BUILD_V7843='RICE NAVI v78.44 / build 78ui44 GitHub under100 load-fix';
